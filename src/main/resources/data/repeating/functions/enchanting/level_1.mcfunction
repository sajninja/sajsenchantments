...
execute if entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/is_crossbow] if entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/unenchanted] run data modify entity @e[type=item,distance=0,limit=1] Item.tag.display.Lore prepend value '[{"text": "Repeating I", "color": "gray", "italic": false}]'
execute if entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/is_crossbow] unless entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/unenchanted] if data entity @e[type=item,limit=1,distance=0,nbt={Item:{tag:{RepeatingLoreValue:1}}}] Item.tag.display.Lore.[1] run data modify entity @e[type=item,distance=0,limit=1] Item.tag.display.Lore.[1] set value '[{"text": "Repeating I", "color": "gray", "italic": false}]'
execute if entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/is_crossbow] unless entity @e[type=item,limit=1,distance=0,predicate=repeating:enchanting/unenchanted] unless data entity @e[type=item,limit=1,distance=0,nbt={Item:{tag:{RepeatingLoreValue:1}}}] Item.tag.display.Lore.[1] run data modify entity @e[type=item,distance=0,limit=1] Item.tag.display.Lore.[0] set value '[{"text": "Repeating I", "color": "gray", "italic": false}]'
...
execute if entity @e[type=item,distance=0,limit=1,predicate=repeating:enchanting/is_book] run data modify entity @e[type=item,distance=0,limit=1] Item.tag.display.Lore.[0] set value '[{"text": "Repeating I", "color": "gray", "italic": false}]'
